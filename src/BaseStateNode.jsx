...
function BaseStateNode({ nodeId, renderAdditionalControls, renderAdditionalContent, theme }) {
    ...
    const renderControls = () => (<>
        ...
        <button
            ...
            <FontAwesomeIcon className="h-6 w-3" icon={faUpload}/>
    ...
    return (<>
        ...
        <ConfirmationDialog isOpen={isConfirmation} setIsOpen={setIsConfirmation} onAccept={onPurgeStateData} title="Purge complete state data" content="this process is not reversable... are you sure you wish to delete all data within the selected state."/>

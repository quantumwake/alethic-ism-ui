...
export const FilesTab = ({ onItemClick }) => {
    ...
    const fileStructure = [
        {
            ...
            type: 'folder',
            children: [
                { id: 'app.js', label: 'app.js', icon: FileCode, type: 'file' },
                { id: 'index.js', label: 'index.js', icon: FileCode, type: 'file' },
                {
                    id: 'components',
                    label: 'components',
                    icon: Folder,
                    type: 'folder',
                    children: [
                        { id: 'Terminal.jsx', label: 'Terminal.jsx', icon: FileCode, type: 'file' },
                        { id: 'Layout.jsx', label: 'Layout.jsx', icon: FileCode, type: 'file' }
                    ]
                }
            ]
        },

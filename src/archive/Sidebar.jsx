...
const processorStyles = {
    ...
    SQL: {
        type: "processor_datasource_sql",
        name: "SQL",
        tooltip: "Query and update RDMS database attached to a function and or process",
        color: 'text-green-500',
        icon: faDatabase,
        enabled: true
    },
    // UserInteraction: {
    //     type: "processor_user_interaction",
    //     name: "User Interaction",
    //     tooltip: "User Interaction Input",
